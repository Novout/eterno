<template>
  <div class="gradient flex gap-10 flex-col items-center webkit w-full">
    ...
    <h1 class="poppins text-6xl">Eterno.</h1>
    <p class="poppins-light">A lightweight browser.</p>
    <input placeholder="Look for something that interests you..." class="w-50% h-12 px-5 py-2 shadow-lg text-lg rounded-2xl border border-black" @keyup.enter="onInput" v-model="input" type="text" autocomplete="true" />
  </div>
</template>
