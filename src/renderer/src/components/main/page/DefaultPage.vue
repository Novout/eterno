<template>
  <div class="gradient flex gap-10 flex-col items-center webkit w-full">
    ...
    <input :placeholder="t('default.placeholder')" class="w-50% h-12 px-5 py-2 shadow-lg text-lg rounded-2xl border border-black" @keyup.enter="onInput" v-model="input" type="text" autocomplete="true" />
  </div>
</template>
